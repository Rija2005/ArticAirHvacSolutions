...
//       "You've been assigned a new job. Check your schedule for details.",
//       request,
//       job._id
//     );
//   }
...
//     .populate({ path: "request", populate: ["service", { path: "customer", select: "name email phone address" }] })
...
//     .populate({ path: "request", populate: [{ path: "service" }, { path: "customer", select: "name email phone address" }] });
//   res.json(jobs);
// });
