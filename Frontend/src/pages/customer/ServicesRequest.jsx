...
//           type="button"
//           onClick={() => onChange(n)}
//           className={`text-2xl leading-none ${n <= value ? "text-accent-500" : "text-gray-200"}`}
...
//         <h1 className="text-xl md:text-2xl font-medium">My service requests</h1>
...
//       <Card>
//         {requests.length === 0 ? (
//           <p className="text-sm text-gray-400">You haven't made any requests yet.</p>
//         ) : (
...
//                 className="w-full flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-gray-100 pb-3 last:border-0 gap-2 hover:bg-gray-50 -mx-2 px-2 py-1 rounded-lg text-left"
//               >
//                 <div>
//                   <p className="text-sm font-medium">{r.service?.name}</p>
//                   <p className="text-xs text-gray-500">{r._id.slice(-6)} · {formatDate(r.createdAt)}</p>
//                 </div>
...
//       <Modal isOpen={!!selected} onClose={() => setSelected(null)} title={selected?.service?.name}>
//         {selected && (
...
//                       <div className={`w-3 h-3 rounded-full ${i <= currentStep ? "bg-primary-600" : "bg-gray-200"}`} />
//                       {i < steps.length - 1 && (
...
//                   <span>Pending</span><span>Scheduled</span><span>In progress</span><span>Completed</span>
//                 </div>
//               </>
//             )}
//             <div className="text-sm space-y-2">
//               <p><span className="text-gray-500">Description:</span> {selected.description}</p>
//               <p><span className="text-gray-500">Preferred date:</span> {formatDate(selected.preferredDate)}</p>
//             </div>

//             {selected.status === "completed" && (
//               <div className="border-t border-gray-100 pt-4">
//                 {alreadyReviewed ? (
//                   <p className="text-sm text-primary-600">You've already reviewed this service. Thank you!</p>
//                 ) : (
//                   <div className="space-y-3">
//                     <p className="text-sm font-medium">How was your service?</p>
...
//     <h3 className="font-medium">Service Report</h3>
...
//       <div>
//         <p className="text-sm font-medium mb-2">Before Images</p>
...
//       <div>
//         <p className="text-sm font-medium mb-2">After Images</p>
...
//   );
// }
// src/pages/customer/ServiceRequests.jsx
import { useState, useEffect } from "react";
import { Link } from "react-router-dom";
import { toast } from "react-toastify";
import { 
