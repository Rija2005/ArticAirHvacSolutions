...
//   return (
//     <div className="min-h-screen bg-gradient-to-b from-slate-100 via-slate-50 to-slate-100 py-16 px-4 sm:px-6 lg:px-8 flex flex-col justify-center">
...
//             <FiMessageSquare className="text-primary-500" /> Customer Feedback
//           </div>
...
//         {/* Carousel Content */}
//         {reviews.length === 0 ? (
//           <Card className="text-center py-10 bg-white/80 backdrop-blur-xl border border-slate-200/80 rounded-2xl shadow-sm max-w-sm mx-auto">
//             <div className="w-10 h-10 rounded-xl bg-slate-100 text-slate-400 flex items-center justify-center mx-auto text-lg mb-2">
//               <FiMessageSquare />
//             </div>
...
//                     <Card className="bg-white/90 backdrop-blur-xl border border-slate-200/80 rounded-2xl p-5 sm:p-6 shadow-lg shadow-slate-200/40">
...
//                       <p className="text-xs sm:text-sm text-slate-600 my-4 leading-relaxed italic">
//                         "{r.comment}"
//                       </p>
