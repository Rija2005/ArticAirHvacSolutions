      ...
      return (
        <Button
          ...
          className={`py-2 px-3.5 rounded-xl text-xs font-bold transition-all duration-200 flex items-center gap-2 ${
            isBusy
              ? "!opacity-100 !bg-slate-100 dark:!bg-slate-800/60 !text-slate-600 dark:!text-slate-400 !border !border-slate-200 dark:!border-slate-700 cursor-not-allowed"
        ...
        >
          <span className={`w-2 h-2 rounded-full ${isBusy ? "bg-rose-500" : "bg-emerald-400"}`} />
