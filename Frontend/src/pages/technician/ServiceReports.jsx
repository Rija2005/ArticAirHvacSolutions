// // src/pages/technician/ServiceReports.jsx
...
//     setLoading(true);
//     try {
//       // THIS is the block from the last message — it belongs right here,
//       // inside handleSubmit, using the actual state values from this component
...
//       <h1 className="text-xl md:text-2xl font-medium">Service report</h1>
...
//               {activeJobs.map((j) => (
//                 <option key={j.id} value={j.id}>{j.id} — {j.service} ({j.customer})</option>
//               ))}
//             </select> */}
//             <select
//   value={jobId}
...
//       {j.request?.service?.name || "Service"} —{" "}
...
//           <div>
//             <label className="text-sm text-gray-600">Service notes</label>
//             <textarea
//               value={notes}
...
//           <div>
//             <label className="text-sm text-gray-600">Customer signature</label>
//             <div
//               onClick={() => { setSigned(true); setSignatureData("signed-placeholder-base64"); }}
//               className={`h-28 border-2 border-dashed rounded-lg flex items-center justify-center text-sm cursor-pointer ${
//                 signed ? "border-primary-500 bg-primary-50 text-primary-700" : "border-gray-300 text-gray-400"
//               }`}
//             >
//               {signed ? "Signature captured ✓" : "Tap to capture signature"}
//             </div>
//           </div>
...
//             </Button>
//             {submitted && <span className="text-sm text-green-600">Report submitted</span>}
//           </div>
//         </form>
//       </Card>
//     </div>
