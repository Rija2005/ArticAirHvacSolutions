...
//     { label: "Completed this week", value: jobs.filter((j) => j.status === "completed").length },
//   ];
...
//           <h2 className="font-medium">Assigned jobs today</h2>
//           <Link to="/technician/jobs" className="text-sm text-primary-600 dark:text-primary-400">View all</Link>
//         </div>
//         {todayJobs.length === 0 ? (
//           <p className="text-sm text-gray-400 dark:text-slate-500">No jobs scheduled for today.</p>
//         ) : (
//           <div className="space-y-3">
//             {todayJobs.map((j) => (
//               <div key={j._id} className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-gray-100 dark:border-slate-800 pb-3 last:border-0 gap-2">
//                 <div>
//                   <p className="text-sm font-medium">
//                     {j.request?.service?.name} — {j.request?.customer?.name}
//                   </p>
//                   <p className="text-xs text-gray-500 dark:text-slate-400">{j._id.slice(-6)}</p>
//                 </div>
