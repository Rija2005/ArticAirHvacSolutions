...
//   return (
//     <div className="relative min-h-screen p-2 md:p-6 space-y-6 overflow-hidden rounded-2xl bg-gradient-to-br from-slate-50 via-sky-50/30 to-orange-50/20">
//       {/* Dynamic Animated Background Blobs */}
//       <div className="absolute top-0 -left-20 w-72 h-72 bg-primary-500/10 rounded-full blur-3xl animate-pulse pointer-events-none" />
//       <div className="absolute bottom-0 -right-20 w-80 h-80 bg-accent-500/10 rounded-full blur-3xl animate-pulse pointer-events-none" />
...
//           <p className="text-xs md:text-sm text-gray-500 mt-1">View, search, and manage your active customer base.</p>
//         </div>

//         <div className="relative w-full sm:w-72">
//           <i className="ti ti-search absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-400 text-base" aria-hidden="true" />
//           <input
//             placeholder="Search name or email..."
//             value={search}
//             onChange={(e) => setSearch(e.target.value)}
//             className="w-full pl-10 pr-4 py-2.5 bg-white/80 backdrop-blur-md border border-gray-200 rounded-xl text-sm transition-all duration-200 shadow-sm placeholder:text-gray-400 hover:border-accent-500 focus:border-primary-500 focus:ring-4 focus:ring-primary-50 focus:outline-none"
//           />
//         </div>
//       </div>

//       {/* Main Glassmorphism Data Card */}
//       <Card className="relative z-10 border border-white/60 bg-white/70 backdrop-blur-md shadow-xl rounded-2xl overflow-hidden">
//         <div className="overflow-x-auto">
//           <table className="w-full text-sm">
//             <thead>
//               <tr className="text-left text-xs font-semibold uppercase tracking-wider text-gray-400 border-b border-gray-100 bg-gray-50/50">
...
//               {loading ? (
//                 <tr>
//                   <td colSpan={5} className="py-8 text-center text-gray-400 text-sm">Loading customers...</td>
//                 </tr>
//               ) : filtered.length > 0 ? (
//                 filtered.map((c) => (
//                   <tr 
//                     key={c._id} 
//                     className="group hover:bg-sky-50/40 transition-all duration-200"
//                   >
...
//                       </div>
//                       <div>
//                         <p className="font-semibold text-gray-800 group-hover:text-primary-700 transition-colors">{c.name}</p>
...
//                       <span className="inline-flex items-center gap-1 bg-gray-100 px-2.5 py-0.5 rounded-full text-xs font-semibold">
//                         <i className="ti ti-file-text text-gray-400" aria-hidden="true" />
//                         {c.requests || 0}
//                       </span>
//                     </td>
...
//                           variant="secondary"
//                           className="text-xs px-3 py-1 bg-white hover:bg-accent-500 hover:text-white border border-gray-200 group-hover:border-accent-500 shadow-sm transition-all duration-200"
//                         >
//                           View
//                         </Button>
//                         <Button
...
//             <div className="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-primary-50 to-orange-50/50 border border-primary-100/50">
...
//                 <p className="font-medium text-gray-700 mt-0.5 truncate">{selected.email}</p>
//               </div>
//               <div className="p-3 bg-gray-50 rounded-lg border border-gray-100">
//                 <p className="text-xs text-gray-400 font-medium uppercase">Phone</p>
//                 <p className="font-medium text-gray-700 mt-0.5">{selected.phone}</p>
//               </div>
//               <div className="p-3 bg-gray-50 rounded-lg border border-gray-100">
//                 <p className="text-xs text-gray-400 font-medium uppercase">Total Requests</p>
//                 <p className="font-medium text-gray-700 mt-0.5">{selected.requests}</p>
//               </div>
//               <div className="p-3 bg-gray-50 rounded-lg border border-gray-100">
//                 <p className="text-xs text-gray-400 font-medium uppercase">Region</p>
//                 <p className="font-medium text-gray-700 mt-0.5">{selected.location || "N/A"}</p>
//               </div>
//             </div>
