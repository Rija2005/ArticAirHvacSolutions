...
//   const inputBase =
//     "w-full pl-10 pr-10 py-2.5 text-sm rounded-xl border bg-white/80 transition-all duration-200 outline-none placeholder:text-gray-400 hover:border-accent-500 focus:border-primary-500 focus:ring-4 focus:ring-primary-50";
...
//       <Card className="relative z-10 w-full max-w-md p-8 border border-white/10 bg-white/90 backdrop-blur-xl shadow-2xl rounded-2xl">
...
//           </div>
//           <h1 className="text-2xl font-bold text-gray-800 tracking-tight">Set a new password</h1>
//           <p className="text-xs md:text-sm text-gray-500 mt-1">Choose a strong new password for your account.</p>
//         </div>

//         {success ? (
//           <div className="text-center space-y-4">
//             <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-success-500/10 text-success-500 mb-1">
//               <FiCheckCircle className="text-2xl" />
//             </div>
//             <p className="text-sm text-gray-600">Your password has been reset. Redirecting you to login...</p>
//           </div>
//         ) : (
