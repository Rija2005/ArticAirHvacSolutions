...
//       // Toast notice for missing fields
...
//       // Styled Toast Notification for Success
//       toast.success(`Welcome back, ${user.name}!`, {
//         icon: <FiCheckCircle className="text-xl text-emerald-500" />,
//         className: "border border-emerald-100 bg-white shadow-lg",
//       });
...
//       // Custom Toast Notification for Errors
//       toast.error(message, {
//         icon: <FiAlertCircle className="text-xl text-red-500" />,
//         className: "border border-red-100 bg-white shadow-lg",
//       });
//     } finally {
//       setLoading(false);
//     }
...
//   const inputBase =
//     "w-full pl-10 pr-4 py-2.5 text-sm rounded-xl border bg-white/80 transition-all duration-200 outline-none placeholder:text-gray-400 hover:border-accent-500 focus:border-primary-500 focus:ring-4 focus:ring-primary-50";
  
//   const inputClass = (field) =>
//     `${inputBase} ${fieldErrors[field] ? "border-red-400 focus:ring-red-100" : "border-gray-200"}`;

//   return (
//     <div className="relative min-h-screen flex items-center justify-center px-6 overflow-hidden bg-gradient-to-br from-slate-900 via-sky-950 to-slate-900">
      
//       {/* Dynamic Animated Ambient Background Lights */}
//       <div className="absolute top-1/4 -left-20 w-80 h-80 bg-primary-500/20 rounded-full blur-3xl animate-pulse pointer-events-none" />
//       <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-accent-500/20 rounded-full blur-3xl animate-pulse pointer-events-none" />

//       {/* Main Glassmorphism Login Card */}
//       <Card className="relative z-10 w-full max-w-md p-8 border border-white/10 bg-white/90 backdrop-blur-xl shadow-2xl rounded-2xl transform transition-all duration-300 hover:shadow-primary-500/10">
...
//           <p className="text-xs md:text-sm text-gray-500 mt-1">Log in to your account</p>
//         </div>
...
//                 Password
//               </label>
//               <Link to="/forgot-password" className="text-xs font-medium text-primary-600 hover:text-accent-600 transition-colors">
//                 Forgot?
//               </Link>
//             </div>
//             <div className="relative">
...
//           <Link to={`/register${redirect ? `?redirect=${encodeURIComponent(redirect)}` : ""}`} className="font-semibold text-primary-600 hover:text-accent-600 transition-colors">
//             Register
//           </Link>
//         </p>
//       </Card>
