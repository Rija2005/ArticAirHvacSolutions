...
//             <span className={`text-xs font-semibold ${!isAnnual ? "text-slate-900" : "text-slate-400"}`}>
//               Monthly
//             </span>
//             <button
//               type="button"
//               onClick={() => setIsAnnual(!isAnnual)}
//               className="relative w-14 h-8 rounded-full bg-slate-900 p-1 transition-colors duration-300 focus:outline-none"
//             >
//               <div
...
//               />
//             </button>
//             <span className={`text-xs font-semibold flex items-center gap-1.5 ${isAnnual ? "text-slate-900" : "text-slate-400"}`}>
//               Annual
...
//                 {p.highlight && (
//                   <div className="absolute -inset-0.5 bg-gradient-to-r from-accent-500 to-orange-500 rounded-3xl blur opacity-30 group-hover:opacity-100 transition duration-300" />
//                 )}

//                 <Card 
//                   className={`relative flex flex-col justify-between h-full bg-white/90 backdrop-blur-xl rounded-3xl p-6 sm:p-8 border transition-all duration-300 ${
//                     p.highlight 
//                       ? "border-accent-500/80 shadow-2xl shadow-accent-500/10" 
//                       : "border-slate-200/80 hover:border-slate-300 hover:shadow-xl"
//                   }`}
//                 >
//                   <div>
//                     {/* Header Badge & Title */}
...
//                         p.highlight ? "bg-accent-500 text-white shadow-lg shadow-accent-500/30" : "bg-primary-50 text-primary-600"
//                       }`}>
//                         <Icon />
//                       </div>
...
//                     <p className="text-xs text-slate-500 mt-1 min-h-[32px] leading-relaxed">{p.desc}</p>

//                     {/* Dynamic Pricing Display */}
//                     <div className="my-6 pt-4 border-t border-slate-100 flex items-baseline gap-1">
//                       <span className="text-4xl font-extrabold text-slate-900 tracking-tight">{price}</span>
//                       <span className="text-xs font-semibold text-slate-400">{cycle}</span>
//                     </div>
...
//                             p.highlight ? "bg-emerald-100 text-emerald-600" : "bg-primary-50 text-primary-600"
//                           }`}>
//                             <FiCheck className="text-xs stroke-[3]" />
//                           </div>
//                           <span className="leading-tight text-slate-700">{f}</span>
//                         </li>
//                       ))}
//                     </ul>
//                   </div>
...
//         <div className="bg-white/80 backdrop-blur-xl border border-slate-200/80 rounded-3xl p-6 sm:p-8 shadow-sm grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
//           <div className="flex flex-col items-center gap-2">
//             <div className="w-10 h-10 rounded-xl bg-primary-50 text-primary-600 flex items-center justify-center text-lg">
//               <FiClock />
//             </div>
//             <h3 className="text-sm font-bold text-slate-800">No Long-Term Lock-in</h3>
//             <p className="text-xs text-slate-500">Cancel or upgrade your maintenance plan anytime without hassle.</p>
//           </div>
...
//               <FiAward />
//             </div>
//             <h3 className="text-sm font-bold text-slate-800">100% Workmanship Guarantee</h3>
//             <p className="text-xs text-slate-500">All maintenance tune-ups come with a 30-day performance warranty.</p>
//           </div>

//           <div className="flex flex-col items-center gap-2">
//             <div className="w-10 h-10 rounded-xl bg-accent-50 text-accent-600 flex items-center justify-center text-lg">
//               <FiShield />
//             </div>
//             <h3 className="text-sm font-bold text-slate-800">Certified Local Techs</h3>
//             <p className="text-xs text-slate-500">Background-checked, NATE-certified technicians assigned to your home.</p>
//           </div>
//         </div>
