...
//       {/* Trust & Differentiation Section (Replaces Core Services Grid) */}
//       <section className="px-6 py-20 max-w-6xl mx-auto space-y-16">

//         {/* Section Header */}
//         <div className="text-center space-y-3 max-w-2xl mx-auto">
//           <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-primary-50 border border-primary-100 text-primary-700 text-xs font-semibold uppercase tracking-wider">
//             The Arctic Air Standard
//           </div>
//           <h2 className="text-3xl font-extrabold text-slate-800 tracking-tight">Why Homeowners Trust Us</h2>
...
//               <Card
//                 key={item.title}
//                 className="group relative bg-white border border-slate-200/80 p-6 rounded-2xl transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:border-primary-500/40 flex flex-col justify-between"
//               >
//                 <div className="space-y-4">
//                   <div className="flex items-center justify-between">
//                     <div className="w-12 h-12 rounded-xl bg-primary-50 text-primary-600 flex items-center justify-center group-hover:bg-primary-600 group-hover:text-white transition-colors duration-300 shadow-sm">
//                       <PillarIcon className="text-xl" />
//                     </div>
//                     <span className="text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 bg-emerald-50 text-emerald-700 border border-emerald-200/60 rounded-full">
//                       {item.highlight}
//                     </span>
//                   </div>

//                   <div>
//                     <h3 className="font-bold text-base text-slate-800 group-hover:text-primary-600 transition-colors duration-200">
//                       {item.title}
//                     </h3>
...
//         <div className="bg-white border border-slate-200/80 rounded-2xl p-6 md:p-8 shadow-sm flex flex-col lg:flex-row items-center justify-between gap-8">
//           <div className="grid grid-cols-3 gap-6 w-full lg:w-auto text-center lg:text-left divide-x divide-slate-100">
//             <div className="pr-2">
//               <p className="text-2xl md:text-3xl font-extrabold text-primary-700">10k+</p>
//               <p className="text-xs text-slate-500 font-medium">Repairs Completed</p>
//             </div>
//             <div className="px-2">
//               <p className="text-2xl md:text-3xl font-extrabold text-primary-700">4.9★</p>
//               <p className="text-xs text-slate-500 font-medium">Google Rating</p>
//             </div>
//             <div className="pl-2">
//               <p className="text-2xl md:text-3xl font-extrabold text-primary-700">100%</p>
//               <p className="text-xs text-slate-500 font-medium">Guaranteed Care</p>
//             </div>
//           </div>
...
//               <Button
//                 variant="secondary"
//                 className="w-full sm:w-auto py-2.5 px-5 bg-slate-900 hover:bg-slate-800 text-white font-semibold text-xs rounded-xl transition-all flex items-center justify-center gap-2"
//               >
