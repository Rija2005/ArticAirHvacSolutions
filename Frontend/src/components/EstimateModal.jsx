...
//       if (res.data.length > 0 && !selectedId) setSelectedId(res.data[0]._id);
//       setLoading(false);
//     });
...
//       {loading ? (
//         <div className="h-40 flex items-center justify-center text-sm text-gray-400">Loading services...</div>
//       ) : (
...
//                   className={`text-sm px-3 py-2 rounded-xl border text-left transition-colors ${
//                     selectedId === s._id
...
//               <span className="font-medium text-gray-900">{sqft.toLocaleString()} sq ft</span>
//             </div>
//             <input
...
//                   !urgent ? "border-primary-600 bg-primary-50 text-primary-700 font-medium" : "border-gray-200 text-gray-600"
//                 }`}
//               >
//                 Normal
//               </button>
...
//                 className={`flex-1 text-sm px-3 py-2 rounded-xl border transition-colors ${
//                   urgent ? "border-red-500 bg-red-50 text-red-700 font-medium" : "border-gray-200 text-gray-600"
//                 }`}
//               >
//                 Emergency
//               </button>
...
//           <div>
//             <label className="text-sm text-gray-600 mb-2 block">Additional services</label>
//             <div className="space-y-2">
//               {additionalOptions.map((opt) => (
//                 <label key={opt.id} className="flex items-center gap-2 text-sm text-gray-600 cursor-pointer">
//                   <input
//                     type="checkbox"
...
//           <div className="rounded-2xl bg-primary-700 text-white p-5 text-center">
//             <p className="text-xs text-primary-100 uppercase tracking-wide">Estimated range</p>
//             <p className="text-3xl font-medium mt-1">{formatCurrency(low)} – {formatCurrency(high)}</p>
//             <p className="text-xs text-primary-100 mt-2">Final quote confirmed after a technician reviews your request</p>
//           </div>

//           <Link to={`/request-quote?service=${selected?.name.toLowerCase().replace(/\s+/g, "-")}`} onClick={onClose}>
//             <Button variant="accent" className="w-full">Get my exact quote</Button>
//           </Link>
//         </div>
//       )}
//     </Modal>
